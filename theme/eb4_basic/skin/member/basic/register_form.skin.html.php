...
<div class="register-form">
    ...
    <div class="register-box">
        ...
        <fieldset>
            <input type="hidden" value="<?php echo $login_code; ?>" id="login_code" name="login_code" />
            <input type="hidden" value="<?php echo $login_email; ?>" id="login_email" name="login_email" />
            <div class="row">
        ...
        <fieldset>
            ...
            <div class="row">
                <section class="col-lg-6">
                    ...
                    <label class="input input-button required-mark">
                        <input type="hidden" name="old_email" value="<?php echo $login_email ? $login_email : $member['mb_email']; ?>">
                        <i class="icon-prepend far fa-envelope"></i>
                        <input type="text" name="mb_email" value="<?php if (isset($member['mb_email'])) { ?><?php echo $member['mb_email']; ?><?php } if ($login_email) { ?><?php echo $login_email; ?><?php } ?>" id="reg_mb_email" required size="70" maxlength="100" <?php echo $login_email ? 'readonly' : ''; ?> />
                        <?php if ($w=='') { ?>
