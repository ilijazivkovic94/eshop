...
$action_url1 = G5_ADMIN_URL . '/?dir=member&amp;pid=friend_list_view_update&amp;smode=1';
...
$sql_common = " from g5_friends as a left join {$g5['member_table']} as b on a.email = b.mb_email ";
...
if ($stx) {
    ...
    switch ($sfl) {
        ...
        case 'mb_hp':
            ...
            break;
        default:
            $sql_search .= " (a.parent_mb_id like '{$stx}%') ";
            break;
    }
    $sql_search .= " ) ";
}
...
$sql = " select *, b.mb_id as real_mb_id {$sql_common} {$sql_search} {$sql_order} limit {$from_record}, {$rows} ";
