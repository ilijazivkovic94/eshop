...
$action_url1 = G5_ADMIN_URL . '/?dir=member&amp;pid=friend_list_update&amp;smode=1';
...
for ($i=0; $row=sql_fetch_array($result); $i++) {
    ...
    $friend_sql = "select count(mb_id) as cnt from g5_friends where parent_mb_id='$mb_id'";
    $friend_result = sql_query($friend_sql);
    $friend_row=sql_fetch_array($friend_result);
    ...
    $list[$i]['friend_cnt'] = $friend_row['cnt'];
    $k++;
}
