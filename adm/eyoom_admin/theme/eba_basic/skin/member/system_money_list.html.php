...
<div class="admin-point-list">
    ...
    <div class="m-b-5">
        <div class="float-start f-s-13r">
            ...
            <span class="m-l-7">(<?php echo $mb['mb_id']; ?> 님 시스템머니 합계 : <?php echo number_format($mb['mb_system_money']); ?>원)</span>
            <?php } else { ?>
            <span class="m-l-7">(전체 합계 <?php echo number_format($sum_money); ?>원)</span>
            <?php } ?>
        </div>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo number_format($list[$i]['po_money']); ?></td>
                        <td><?php echo $list[$i]['po_datetime']; ?></td>
                        <td><?php echo $list[$i]['expire_date']; ?></td>
                        <td><?php echo number_format($list[$i]['po_mb_money']); ?></td>
                    </tr>
                    <?php } ?>
    ...
    <form name="fmoneylist2" method="post" id="fmoneylist2" action="<?php echo $action_url2; ?>" autocomplete="off" class="eyoom-form">
    <input type="hidden" name="sfl" value="<?php echo $sfl ?>">
    <input type="hidden" name="stx" value="<?php echo $stx ?>">
    ...
    <div class="adm-form-table m-b-20">
        <div class="adm-form-header"><strong><i class="las la-caret-right m-r-10"></i>개별회원 머니 증감 설정</strong></div>
        <div class="adm-form-tr">
            <div class="adm-form-td td-l">
        ...
        <div class="adm-form-tr-wrap">
            ...
            <div class="adm-form-tr tr-r">
                <div class="adm-form-td td-l">
                    <label for="po_system_money" class="label">머니</label>
                </div>
                <div class="adm-form-td td-r">
                    <label class="input max-width-250px">
                        <input type="text" name="po_system_money" id="po_system_money" value="" required>
                    </label>
                </div>
            </div>
        </div>
